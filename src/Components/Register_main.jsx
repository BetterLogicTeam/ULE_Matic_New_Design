    ...
    if (acc == "No Wallet") {
      ...
      try {
        ...
        if (paymentType !== "BNB") {
          ...
          toast.error("Please Select BNB Chain")
          setloader(false);
              ...
              isVisible ?
                <div id="myModal " class="mypop Register_model">
                  ...
                  >
                    ...
                    <select className="boxset" name="position" aria-label="Default select example" defaultValue={selectPosition} onChange={(e) => setselectPosition(e.target.value)}>
