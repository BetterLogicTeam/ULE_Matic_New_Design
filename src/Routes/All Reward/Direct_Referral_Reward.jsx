            ...
            <div className="page-wrapper">
                <div className="page-content">
                    ...
                    <div className="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                        <div className="breadcrumb-title pe-3">Activation Direct Reward</div>
                        <div className="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb mb-0 p-0">
                                    ...
                                    <li className="breadcrumb-item active" aria-current="page">All Reward / Activation Direct Reward</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
