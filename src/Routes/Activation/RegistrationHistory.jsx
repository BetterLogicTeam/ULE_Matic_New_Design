...
function RegistrationHistory() {
    ...
    const referral_API = async () => {
        try {
            ...
            let responce = await API?.get(`registrationHistory?id=${uId}`)
            ...
            <div className="page-wrapper">
                <div className="page-content">
                    ...
                    <div className="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                        <div className="breadcrumb-title pe-3">Registration History</div>
                        <div className="ps-3">
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb mb-0 p-0">
                                    ...
                                    <li className="breadcrumb-item active" aria-current="page">Activation / Registration History</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                                    ...
                                    {referralApi.map((items) => {
                                        return (
                                            <tr>
                                                ...
                                                {items.remark == "BNB" ?
                                                    <td>
                                                        <a href={`https://bscscan.com/tx/${items.txn}`} target={'_blank'} >View Txn</a>
                                                    </td>
                                                    :
                                                    <td>
                                                        <a href={`https://polygonscan.com/tx/${items.txn}`} target={'_blank'} >View Txn</a>
                                                    </td>
                                                }
                                                <td>{items?.date}</td>
                                            </tr>
